...
\usepackage{listings}       % Para listings de codigo
...
\input{plataformas/plataformas}
\input{plataformas/linux}
\input{plataformas/windows}
\input{plataformas/mac}
\newpage

\input{implementacion/implementacion}
\input{implementacion/process}
\input{implementacion/memaccess}
\input{implementacion/memsearch}
\input{implementacion/listlibs}
\newpage
