...
\include{plataformas/plataformas}
\include{plataformas/linux}
\include{plataformas/windows}
\include{plataformas/mac}

\include{implementacion/implementacion}
\include{implementacion/process}
\include{implementacion/memaccess}
\include{implementacion/memsearch}
\include{implementacion/listlibs}

\include{apendices/apendices}
\include{apendices/go}
\include{apendices/ejemplo}
