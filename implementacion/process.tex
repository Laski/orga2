...
En el caso de OS X un proceso es representado por un \texit{task_t} que es un
renombre de un \texit{mach_port_t}, un puerto a través del cual comunicarse con
el proceso y poder inspeccionar distintas características de este. Abrir un
proceso luego consiste simplemente llamar a \texit{task_for_pid} y cerrarlo de
alocar el task.
...
complejo. En particular las funciones \texit{proc_pidpath} y
